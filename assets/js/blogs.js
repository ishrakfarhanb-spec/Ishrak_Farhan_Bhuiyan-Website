;(function(){
    ...
    posts.slice(0,3).forEach(function(p){
      var card = el('article', {class:'card'} , [
        el('div', {class:'card-body'}, [
          ...
          el('p', {text:p.excerpt}),
          el('a', {class:'btn btn-link', href:'blogs-hub.html#'+p.slug, text:'Read'})
        ])
      ]);
  ...
  function renderFeatured(posts){
    ...
    var read = el('a', {href:'blogs-hub.html#'+p.slug, class:'btn btn-primary', text:'Read'});
  ...
  function renderGrid(posts){
    ...
    posts.forEach(function(p){
      var a = el('a', {href: 'blogs-hub.html#'+p.slug, class:'card'});
